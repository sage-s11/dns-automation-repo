...
public class ImportCommand {
    ...
    public static void main(String[] args) {
        ...
        try {
           ...
           // Step 9: Execute import (BATCH MODE - FAST!)
            System.out.println();
            System.out.println("🚀 Creating DNS records (batch mode)...");
            
            long startTime = System.currentTimeMillis();
            
            BatchImportService batchService = new BatchImportService();
            BatchImportService.BatchResult batchResult = batchService.batchImport(safeRecords);
            ...
            System.out.println("=".repeat(70));
            System.out.println("✅ Created: " + batchResult.created);
            System.out.println("❌ Failed:  " + batchResult.failed);
            System.out.println("⏱️  Database time: " + (elapsed / 1000.0) + "s");
            System.out.println(); 
            // Cleanup
